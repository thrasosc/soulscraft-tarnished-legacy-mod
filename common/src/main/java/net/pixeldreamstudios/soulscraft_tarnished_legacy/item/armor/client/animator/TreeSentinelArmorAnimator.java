...
public class TreeSentinelArmorAnimator extends SoulsCraftArmorAnimator {
    @Override
    public @NotNull ResourceLocation getAnimationLocation(ItemStack itemStack) {
        return ResourceLocation.fromNamespaceAndPath(SoulsCraftTarnishedLegacy.MOD_ID, "animations/armor/tree_sentinel_armor.animation.json");
    }
}
