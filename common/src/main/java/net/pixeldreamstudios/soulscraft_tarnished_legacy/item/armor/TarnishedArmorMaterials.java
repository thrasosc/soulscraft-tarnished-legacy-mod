...
public class TarnishedArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> BLAIDD_ARMOR = SoulsCraftArmorMaterials.registerArmorMaterial(SoulsCraftTarnishedLegacy.MOD_ID, "iron", Util.make(new EnumMap(ArmorItem.Type.class), enumMap -> {
        enumMap.put(ArmorItem.Type.BOOTS, 2);
        enumMap.put(ArmorItem.Type.LEGGINGS, 5);
        enumMap.put(ArmorItem.Type.CHESTPLATE, 6);
        enumMap.put(ArmorItem.Type.HELMET, 2);
