...
public class CrucibleKnightArmorAnimator extends SoulsCraftArmorAnimator {
    @Override
    public @NotNull ResourceLocation getAnimationLocation(ItemStack itemStack) {
        return ResourceLocation.fromNamespaceAndPath(SoulsCraftTarnishedLegacy.MOD_ID, "animations/armor/crucible_knight_armor.animation.json");
    }
}
