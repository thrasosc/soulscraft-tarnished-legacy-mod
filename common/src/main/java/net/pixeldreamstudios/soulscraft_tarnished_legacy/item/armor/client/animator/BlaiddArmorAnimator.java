...
public class BlaiddArmorAnimator extends SoulsCraftArmorAnimator {
    @Override
    public @NotNull ResourceLocation getAnimationLocation(ItemStack itemStack) {
        return ResourceLocation.fromNamespaceAndPath(SoulsCraftTarnishedLegacy.MOD_ID, "animations/armor/blaidd_armor.animation.json");
    }
}
