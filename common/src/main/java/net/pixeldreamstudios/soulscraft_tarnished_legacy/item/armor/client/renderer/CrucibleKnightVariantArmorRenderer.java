...
public class CrucibleKnightVariantArmorRenderer extends SoulsCraftArmorRenderer {

    public CrucibleKnightVariantArmorRenderer() {
        super(
                ResourceLocation.fromNamespaceAndPath(SoulsCraftTarnishedLegacy.MOD_ID, "geo/armor/crucible_knight_armor2.geo.json"),
                ResourceLocation.fromNamespaceAndPath(SoulsCraftTarnishedLegacy.MOD_ID, "textures/armor/crucible_knight_armor2.png"),
